...
export const ApiKeySettingsContent = ({apiKey}: {apiKey: string}) => {
            ...
            <div className="">
                ...
                <div className="mt-1 relative">
                    ...
                    <div className="absolute space-x-0.5 inset-y-0 right-0 flex items-center">
                        <Button variant="ghost" onClick={copyKey} className="p-1 w-10 focus:outline-none focus:ring-2 focus:ring-brand-500">
