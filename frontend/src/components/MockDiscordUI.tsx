    ...
    return (
        <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
            ...
            <div className="hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center">
                 ...
                 {/*Icon */}
                 <div className="flex size-12 bg-discord-brand-color rounded-2xl items-center justify-center mb-2 hover:rounded-xl transition-all duration-200">
            ...
            <div className=" hidden md:flex w-60 bg-[#2f3136] flex-col ">
                ...
                <div className="flex-1 overflow-y-auto pt-4 ">
                    ...
                    <div className="px-2 mb-4">
                        <h3 className="text-xs font-semibold text-[#8e9297] px-2 mb-2 uppercase" >Direct Messages
                        </h3>

                        <div className="flex items-center px-2 py-1.5 rounded bg-[#393c43] text-white cursor-pointer">
                            <img src="/brand-asset-profile-picture.png" alt="PingPanda Avatar"
                            width={32}
                            height={32}
            ...
            <div className="flex-1 flex flex-col">
                ...
                <div className="h-16 bg-[#39393f] flex items-center px-4 shadow-sm border-b border-[#202225]">
                    ...
                    <div className="ml-auto flex items-center space-x-4 text-[#b9bbbe]">
                        <Phone className="sieze-5 hover:text-white cursor-not-allowed hidden sm:block"/>
                        <Video className="sieze-5 hover:text-white cursor-not-allowed hidden sm:block"/>
                        <Pin className="sieze-5 hover:text-white cursor-not-allowed hidden sm:block"/>
                        <UserCircle className="sieze-5 hover:text-white cursor-not-allowed hidden sm:block"/>
                        <Search className="sieze-5 hover:text-white cursor-not-allowed hidden sm:block"/>
                        <Inbox className="sieze-5 hover:text-white cursor-not-allowed hidden sm:block"/>
                        <HelpCircle className="sieze-5 hover:text-white cursor-not-allowed hidden sm:block"/>
                    </div>
                </div>
                ...
                <div className="p-4">
                    <div className="flex items-center bg-[#40444b] rounded-lg p-1">
                        ...
                        <input readOnly type="text" placeholder="Message @PingPanda" className="flex-1 bg-transparent py-2.5 text-white placeholder-[#72767d] focus:outline-none cursor-not-allowed"/>
